...
If your clinic project requires access to a paid model, contact contact Clinic administration to explain your use case. If the use case is appropriate and funds are available, they will create an API key with limited credits for you.
